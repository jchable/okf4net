...
export default function Cli() {
  return (
    <DocsLayout
      ...
      description="Reference for the okf command-line tool: validate, audit, info, index, graph, parse and fmt — arguments, flags, real output, and exit codes. A self-contained Native AOT binary."
      current="cli"
    >
      <PageDoc
        path={
