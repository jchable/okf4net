...
* [N.Shapes](shapes.md) - Shapes, a code container in N.
* [N.Sub](sub.md) - Sub, a code container in N.

# C# Type

* [N.Registry](registry.md) - Keeps the scanners one run knows about.
* [N.Scanner](scanner.md) - Walks a repository and reports what it finds.
